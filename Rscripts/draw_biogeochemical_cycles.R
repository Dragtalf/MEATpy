...
# August 6, 2019
#
# Last updated: April 2025 - BMF (MEATpy)
# Changes:
# - Changed the labels of "Genomes" to "Mags" to be more accurate for cases where the input is a metagenome-assembled genome (MAG) and not a full genome.
#

# Purpose (old METABOLIC description---------------------------
...
drawCcycle.total <- function(R_input, OutputFolder){
  ...
  textplain(mid = c(0.1, 0.80), lab = c("Step2: Carbon fixation",
            paste("Mags:",input.total$Nb.Genome[2]),
...
if (summary==TRUE){
  ...
  # Total
  # in the "Total R input file, the 2nd column is the number of mags and the 3rd column is the Percentage of them.
